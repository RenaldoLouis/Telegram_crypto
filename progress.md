...
4. **Per-signal T1 + direction review** (was gated at ~20 mechanical evals; we're at 23, but lever #1 just changed selection). Wait for post-lever-1 evals, then check per-signal net expectancy and optimal T1 distance.
