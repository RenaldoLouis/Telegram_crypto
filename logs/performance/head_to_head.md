...
| watch | 46 | 39.1% | -0.025 | **-0.056** | 0.86 |
...
|---|---|---|---|---|---|
| (unknown) | 46 | 39.1% | -0.025 | **-0.056** | ✗ below bar |
...
- Whole book: gross -0.105R → **net -0.171R** (PF 0.69, n=388)
...
- **VERDICT: NO edge survives costs yet** — best source net -0.056R (watch). Every source is net-negative or breakeven. The gross edge is a cost illusion; the only path to a real edge is cutting the losing longs and/or raising per-trade R by widening targets or entering closer to stop — NOT more rule-tuning.