...
| watch | 48 | 39.6% | -0.032 | **-0.062** | 0.84 |
...
|---|---|---|---|---|---|
| (unknown) | 48 | 39.6% | -0.032 | **-0.062** | ✗ below bar |
...
- Whole book: gross -0.105R → **net -0.171R** (PF 0.69, n=390)
...
- **VERDICT: NO edge survives costs yet** — best source net -0.062R (watch). Every source is net-negative or breakeven. The gross edge is a cost illusion; the only path to a real edge is cutting the losing longs and/or raising per-trade R by widening targets or entering closer to stop — NOT more rule-tuning.