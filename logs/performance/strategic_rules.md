# Strategic Rules (derived from 341 evaluated trades — solid sample)
_Last updated: 2026-08-30 03:51 UTC_

0. **v11.3 NOT VALIDATING — REVIEW NEEDED**: 104 forward trades only reached 43% WR / -0.05R exp vs targets 34% / +0.00R. ACTION: the last change did NOT deliver — re-audit before adding more rules (do not pile on new delta insights, that is how the bad-logic loop returns).
...
11. **NEUTRAL REGIME LOSING**: 75/246 (30% WR, -0.17 avg R:R over 246 trades). ACTION: During neutral, reduce to max 1-2 setups and require 3/4 TF + volume + fresh entry.
